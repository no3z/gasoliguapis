  ...
  return (
    <GuideShell eyebrow="TRANSPARENCIA" title="Cada dato debe decir de dónde viene" lead="Gasoliguapis separa precio oficial, verificación comunitaria y contenido editorial. No presentamos una ausencia de información como una certeza.">
      <section className="method-steps">
        ...
        <div id="valoraciones"><span>03</span><h2>Puntuaciones de gasolineras y servicios</h2><p>Mostramos por separado la nota general de la parada, los baños, el café y la limpieza, siempre junto al número de votos. Al ordenar por «Mejor puntuadas» aplicamos una media ponderada con una referencia inicial de 3,5 y cinco votos: así, una única valoración de cinco estrellas no domina el listado. Conforme llegan votos, el orden se aproxima a la media real.</p></div>
      ...
      <section>
        ...
        <p>En la consulta del {DATA_SNAPSHOT_DATE} se observaron 11.529 estaciones, 1.000 con precio de GLP, 2.929 con precio de AdBlue y 403 con ambos. Estos recuentos son una fotografía, no una promesa de inventario permanente.</p>
